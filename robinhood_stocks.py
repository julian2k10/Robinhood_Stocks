...
class Robinhood():
    ...
    def __init__(self):
        ...
        if isinstance(self.session.headers, dict) and isinstance(self.payload, dict):
            ...
            authenticate_user = self.read_from_File('auth.txt')
            if isinstance(authenticate_user, dict) and 'username' in list(authenticate_user.keys()):
                ...
                print("\nLogin credentials not found! please don't forget to login...")
                print("Or add 'auth.txt' file to root dir with credentials. e.g.")
                print("{'username': 'johnDoe@gmail.com', 'password' : '154sdsdED'}\n")
